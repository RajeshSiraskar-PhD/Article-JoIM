...
\begin{figure}[t]
        \centering
        \includegraphics[width=0.48\textwidth]{IEEE_06_SensorPlot.png}\hfill
        \includegraphics[width=0.48\textwidth]{SIT_20_SensorPlot.png}
        \caption{IEEE and SIT schema feature plots: Representational plots - depicting the difference in features (sensor data) and value ranges and variations. \textbf{(a)} IEEE schema features. \textbf{(b)} SIT schema features.}
        \label{fig:schema_feature_plots_ieee_sit}
\end{figure}
...
\begin{figure}[t]
        \centering
        \includegraphics[width=0.48\textwidth]{REINFORCE_MH_SIT_12_10.png}\hfill
        \includegraphics[width=0.48\textwidth]{REINFORCE_NW_SIT_12_12.png}
        \caption{REINFORCE trained PdM agents - evaluated on unseen data. \textbf{(a)} REINFORCE with Multi-Head attention. \textbf{(b)} REINFORCE with Nadaraya--Watson attention.}
        \label{fig:reinforce_unseen_mh_nw}
\end{figure}
