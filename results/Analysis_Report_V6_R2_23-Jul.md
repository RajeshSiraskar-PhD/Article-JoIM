...
DETAILS:
==========================================================================================
Algorithm-wise Ablation Details
SIT

--- Ablation Study Results by Algorithm for Schema: SIT ---
Table Caption: SIT - Algorithm-wise ablation summary with mean, SEM, t-statistic, and p-value.
...
--- PPO & REINFORCE Spotlight Summary ---
...
Visualization saved successfully as Ablation_Study_Algo_SIT.jpg
========================================================================================================================

 IEEE

--- Ablation Study Results by Algorithm for Schema: IEEE ---
...
🔍 Analyzing PPO:
  • Baseline Mean Score: 0.7484
  ❌ Attention (in general) did NOT significantly outperform baseline on average.
  ✅ AT LEAST ONE specific mechanism worked! Significant winners:
      - Nadaraya-Watson (Mean: 0.8343, p=0.0434)

🔍 Analyzing REINFORCE:
  • Baseline Mean Score: 0.6696
  ✅ Attention in general significantly OUTPERFORMED baseline overall. (p=0.0007)
  ✅ AT LEAST ONE specific mechanism worked! Significant winners:
      - Nadaraya-Watson (Mean: 0.8008, p=0.0269)
      - Temporal (Mean: 0.8848, p=0.0002)
      - Self-Attention (Mean: 0.8860, p=0.0002)
      - Multi-Head (Mean: 0.8559, p=0.0014)
------------------------------------------------------------

Visualization saved successfully as Ablation_Study_Algo_IEEE.jpg
...
======================================================================
  RUNNING ANALYSIS FOR: ALGOS: ALL
======================================================================

--- Ablation Study Results (Algos: All) for Schema: SIT ---
...
Visualization saved successfully as Ablation_Study_SIT_All_Algos.jpg

======================================================================
  RUNNING ANALYSIS FOR: ALGOS: PPO & REINFORCE
======================================================================

--- Ablation Study Results (Algos: PPO & REINFORCE) for Schema: SIT ---
...
Visualization saved successfully as Ablation_Study_SIT_PPO_REINFORCE.jpg
========================================================================================================================
...
--- Ablation Study Results (Algos: All) for Schema: IEEE ---
...
--- Descriptive Summary ---
The baseline (No Attention) achieved an average Eval_Score of 0.6589.
❌ All Attention: Did NOT significantly outperform the baseline. (Mean Score: 0.5906, p-value: 0.9873)
❌ Nadaraya-Watson: Did NOT significantly outperform the baseline. (Mean Score: 0.5758, p-value: 0.9779)
❌ Temporal: Did NOT significantly outperform the baseline. (Mean Score: 0.5595, p-value: 0.9911)
❌ Self-Attention: Did NOT significantly outperform the baseline. (Mean Score: 0.5498, p-value: 0.9954)
❌ Multi-Head: Did NOT significantly outperform the baseline. (Mean Score: 0.6773, p-value: 0.3215)
--------------------------------------------------
...
--- Ablation Study Results (Algos: PPO & REINFORCE) for Schema: IEEE ---
...
--- Descriptive Summary ---
The baseline (No Attention) achieved an average Eval_Score of 0.7090.
✅ All Attention: Significantly OUTPERFORMED the baseline. (Mean Score: 0.8313, p-value: 0.0002)
✅ Nadaraya-Watson: Significantly OUTPERFORMED the baseline. (Mean Score: 0.8176, p-value: 0.0050)
✅ Temporal: Significantly OUTPERFORMED the baseline. (Mean Score: 0.8228, p-value: 0.0035)
✅ Self-Attention: Significantly OUTPERFORMED the baseline. (Mean Score: 0.8452, p-value: 0.0003)
✅ Multi-Head: Significantly OUTPERFORMED the baseline. (Mean Score: 0.8395, p-value: 0.0005)
--------------------------------------------------
...
*Note: Significant means REINFORCE is statistically significantly better (p < 0.05)*
...
FINAL SUMMARY:
==========================================================================================
Analysis Report -- Date: 23-Jul-2026
==========================================================================================
...
Best overall WITHOUT attention: PPO (mean=0.7484)
Best overall WITH attention: REINFORCE (mean=0.8569)

Statistical tests and inferences (one-tailed Welch t-test, REINFORCE > PPO):
- Baseline: t=-1.3409, p=0.9053, n(REINFORCE)=20, n(PPO)=20 -> claim 'REINFORCE performs better than PPO' is not supported at alpha=0.05.
...
Moved legacy figures to results/:
- results/Ablation_Study_Algo_SIT.jpg
- results/Ablation_Study_SIT_All_Algos.jpg
- results/Ablation_Study_SIT_PPO_REINFORCE.jpg
- results/Ablation_Study_Algo_IEEE.jpg
- results/Ablation_Study_IEEE_All_Algos.jpg
- results/Ablation_Study_IEEE_PPO_REINFORCE.jpg

Displaying figures independently from results/:

Figure: results/Ablation_Study_Algo_IEEE.jpg